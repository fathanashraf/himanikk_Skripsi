        ...
        <div class="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl">
            ...
            <form id="createKeuanganForm" class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" required class="w-full p-4 border border-slate-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent dark:bg-slate-700 dark:text-white transition-all duration-200">
                </div>

                <!-- Nominal -->
                <div>
                    <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-3 required">Nominal (Rp) *</label>
                    <input type="number" name="nominal" step="0.01" min="0" required 
                ...
                <div class="relative">
                    ...
                    <select name="jenis" required class="w-full p-4 pl-12 pr-10 border border-slate-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent dark:bg-slate-700 dark:text-white transition-all duration-200 appearance-none">
                ...
                <div class="relative">
                    ...
                    <select name="type" required class="w-full p-4 pl-12 pr-10 border border-slate-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent dark:bg-slate-700 dark:text-white transition-all duration-200 appearance-none">
                ...
                <div>
                    ...
                    <textarea name="keterangan" rows="3" 
                              class="w-full p-4 border border-slate-200 dark:border-slate-600 rounded-xl resize-vertical focus:ring-2 focus:ring-emerald-500 focus:border-transparent dark:bg-slate-700 dark:text-white transition-all duration-200"
    ...
    <div class="relative top-20 mx-auto p-6 w-11/12 md:w-3/4 lg:w-1/2 max-h-[90vh] overflow-y-auto">
        <div class="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl">
            ...
            <form id="editKeuanganForm" class="p-8 space-y-6">
                ...
                <div>
                    <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-3 required">Nominal (Rp) *</label>
                    <input type="number" name="nominal" id="editNominal" step="0.01" min="0" required 
                           class="w-full p-4 border border-slate-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent dark:bg-slate-700 dark:text-white transition-all duration-200"
                           placeholder="0">
                </div>
                ...
                <div class="relative">
                    <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-3 required">Jenis Transaksi *</label>
                    <select name="jenis" id="editJenis" required class="w-full p-4 pl-12 pr-10 border border-slate-200 dark:border-slate-600 rounded-xl 
                ...
                <div>
                    <label class="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-3 required">Total (Rp) *</label>
                    <input type="number" name="total" id="editTotal" step="0.01" min="0" required 
                           class="w-full p-4 border border-slate-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent dark:bg-slate-700 dark:text-white transition-all duration-200"
                           placeholder="0">
                </div>
...
(function() {
    ...
    window.openEditModal = function(id, keuanganData) {
        ...
        document.getElementById('editJenis').value = keuanganData.jenis || '';
        document.getElementById('editType').value = keuanganData.type || '';
