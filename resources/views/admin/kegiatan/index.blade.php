...
<div class="space-y-8">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 lg:gap-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="min-w-0 flex-1">
                ...
                <p class="text-lg md:text-xl text-gray-600 dark:text-gray-300 font-medium tracking-wide leading-relaxed max-w-2xl">
                    Kelola kegiatan HIMANIKKA dengan nama, deskripsi, status, dan dokumen pendukung
                </p>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-3">
            <!-- Filter Form -->
            <form method="GET" action="{{ route('admin.kegiatan.index') }}" class="flex flex-col sm:flex-row items-end gap-3 flex-1">
                ...
                @if(request()->hasAny(['search', 'status']))
                    <a href="{{ route('admin.kegiatan.index') }}" class="px-6 py-3 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white font-medium transition-colors rounded-xl hover:bg-gray-100 dark:hover:bg-slate-800/50 flex items-center">
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-20 text-center">
                            <div class="max-w-md mx-auto text-gray-500 dark:text-gray-400">
                                ...
                                <h3 class="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Belum ada Kegiatan</h3>
                                <p class="text-lg mb-8">Mulai dengan menambahkan kegiatan HIMANIKKA pertama Anda</p>
                                <button @click="openCreateModal()" 
